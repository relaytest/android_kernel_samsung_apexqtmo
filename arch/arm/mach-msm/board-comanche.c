...
unsigned int gpio_table[][GPIO_REV_MAX] = {
	/* GPIO_INDEX		Rev	{#00,#01,#02,#03 }, */
	/* MDP_VSYNC	*/		{  0,  0,  0,  0 },
	/* VOLUME_UP	*/		{ 78, 50, 50, 50 },
	/* VOLUME_DOWN	*/		{ 81, 81, 81, 81 },
	/* MENU_KEY */			{ 37, 49, 49, 49 },
	/* PTT_KEY */			{ 52, 54, 54, 54 },
	/* ALS_INT */			{ 42, 42, 42,  6 },
	/* ALS_SDA */			{ 63, 12, 12, 12 },
	/* ALS_SCL */			{ 64, 13, 13, 13 },
#ifdef CONFIG_LEDS_MSM_TKEY
	/*TKEY_LED*/			{ 41, 51, 51, 51 },
#endif
};
...
static struct android_pmem_platform_data msm8960_android_pmem_adsp_pdata = {
	.name = "pmem_adsp",
...
static struct android_pmem_platform_data msm8960_android_pmem_audio_pdata = {
	.name = "pmem_audio",
	.allocator_type = PMEM_ALLOCATORTYPE_BITMAP,
	.cached = 0,
	.memory_type = MEMTYPE_EBI1,
...
/* >= BOARD_REV02 */
static const unsigned short comanche_keymap[ADP5588_KEYMAPSIZE] = {
...
static struct adp5588_kpad_platform_data comanche_kpad_data = {
	.rows		= 8,
	.cols		= 10,
	.keymap		= comanche_keymap,
	.keymapsize	= ARRAY_SIZE(comanche_keymap),
	.repeat		= 0,
};
...
static const unsigned int keymap_comanche[] = {
	KEY(0, 0, KEY_1),
	KEY(0, 1, KEY_Q),
	KEY(0, 2, KEY_A),
...
static struct matrix_keymap_data keymap_data_comanche = {
	.keymap_size    = ARRAY_SIZE(keymap_comanche),
	.keymap         = keymap_comanche,
};
static struct pm8xxx_keypad_platform_data keypad_data_comanche = {
	...
	.row_hold_ns            = 91500,
	.wakeup                 = 1,
	.keymap_data            = &keymap_data_comanche,
};
...
static void __init qwerty_keyboard_init(void)
{
	...
	pm8921_data->keypad_pdata = &keypad_data_comanche;
}
...
static struct mxt224_platform_data mxt224_data = {
	...
	.config_fw_version = "I547_At_0117",
};
...
#define PMIC_GPIO_EAR_L		36
#define PMIC_GPIO_EAR_DET		35
#else
...
static struct platform_device *comanche_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init gpio_rev_init(void)
{
	...
	gpio_keys_button[2].gpio = gpio_rev(MENU_KEY);
	gpio_keys_button[3].gpio = GPIO_KEY_HOME;
	gpio_keys_button[4].gpio = GPIO_KEY_BACK;
	gpio_keys_button[5].gpio = gpio_rev(PTT_KEY);
...
static int secjack_gpio_init(void)
{
	...
	rc = pm8xxx_gpio_config(
		PM8921_GPIO_PM_TO_SYS(PMIC_GPIO_EAR_L),
					&ear_l);
	if (rc) {
		pr_err("%s PMIC_GPIO_EAR_L config failed\n", __func__);
		return rc;
	}
#endif
	rc = pm8xxx_gpio_config(
...
static void __init samsung_comanche_init(void)
{
	...
	platform_add_devices(comanche_devices, ARRAY_SIZE(comanche_devices));
...
MACHINE_START(COMANCHE, "SAMSUNG COMANCHE")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_comanche_init,
